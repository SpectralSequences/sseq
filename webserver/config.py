...
SERVER_STARTUP_FILE = REPOSITORY_ROOT / "startup.py"
USER_SERVER_STARTUP_FILE = USER_DIR / "startup.py"
NAMESPACE_FILE = REPOSITORY_ROOT / "namespace.py"
USER_NAMESPACE_FILE = USER_DIR / "namespace.py"

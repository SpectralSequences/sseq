...
fn main() -> error::Result<()> {
    ...
    res.resolve_through_stem(max_degree as u32, max_degree);
    ...
    #[cfg(feature = "concurrent")]
    {
        ...
        res.resolve_through_stem_concurrent(max_degree as u32, max_degree, &bucket);
    }

    println!("\x1b[1m{}", res.graded_dimension_string());
    assert!(!res.has_computed_bidegree(0, max_degree + 1));
    Ok(())
}

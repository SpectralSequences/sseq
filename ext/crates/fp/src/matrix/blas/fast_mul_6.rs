...
impl Matrix {
    pub fn fast_mul_6(&self, b: &Self) -> Matrix {
        ...
        unsafe {
            std::arch::asm!(
                ...
                // Store all 7 results
                "vmovq [{result_data_ptr} + 0], xmm0",   // Store result for limb 0
                "vmovq [{result_data_ptr} + 8], xmm1",   // Store result for limb 1
                "vmovq [{result_data_ptr} + 16], xmm2",  // Store result for limb 2
                "vmovq [{result_data_ptr} + 24], xmm3",  // Store result for limb 3
                "vmovq [{result_data_ptr} + 32], xmm4",  // Store result for limb 4
                "vmovq [{result_data_ptr} + 40], xmm5",  // Store result for limb 5
                "vmovq [{result_data_ptr} + 48], xmm6",  // Store result for limb 6
                ...
                // Store all 7 results
                "vmovq [{result_data_ptr} + 56], xmm0",  // Store result for limb 0
                "vmovq [{result_data_ptr} + 64], xmm1",  // Store result for limb 1
                "vmovq [{result_data_ptr} + 72], xmm2",  // Store result for limb 2
                "vmovq [{result_data_ptr} + 80], xmm3",  // Store result for limb 3
                "vmovq [{result_data_ptr} + 88], xmm4",  // Store result for limb 4
                "vmovq [{result_data_ptr} + 96], xmm5",  // Store result for limb 5
                "vmovq [{result_data_ptr} + 104], xmm6", // Store result for limb 6
                ...
                // Store all 7 results
                "vmovq [{result_data_ptr} + 112], xmm0", // Store result for limb 0
                "vmovq [{result_data_ptr} + 120], xmm1", // Store result for limb 1
                "vmovq [{result_data_ptr} + 128], xmm2", // Store result for limb 2
                "vmovq [{result_data_ptr} + 136], xmm3", // Store result for limb 3
                "vmovq [{result_data_ptr} + 144], xmm4", // Store result for limb 4
                "vmovq [{result_data_ptr} + 152], xmm5", // Store result for limb 5
                "vmovq [{result_data_ptr} + 160], xmm6", // Store result for limb 6
                ...
                // Store all 7 results
                "vmovq [{result_data_ptr} + 168], xmm0", // Store result for limb 0
                "vmovq [{result_data_ptr} + 176], xmm1", // Store result for limb 1
                "vmovq [{result_data_ptr} + 184], xmm2", // Store result for limb 2
                "vmovq [{result_data_ptr} + 192], xmm3", // Store result for limb 3
                "vmovq [{result_data_ptr} + 200], xmm4", // Store result for limb 4
                "vmovq [{result_data_ptr} + 208], xmm5", // Store result for limb 5
                "vmovq [{result_data_ptr} + 216], xmm6", // Store result for limb 6
                ...
                // Store all 7 results
                "vmovq [{result_data_ptr} + 224], xmm0", // Store result for limb 0
                "vmovq [{result_data_ptr} + 232], xmm1", // Store result for limb 1
                "vmovq [{result_data_ptr} + 240], xmm2", // Store result for limb 2
                "vmovq [{result_data_ptr} + 248], xmm3", // Store result for limb 3
                "vmovq [{result_data_ptr} + 256], xmm4", // Store result for limb 4
                "vmovq [{result_data_ptr} + 264], xmm5", // Store result for limb 5
                "vmovq [{result_data_ptr} + 272], xmm6", // Store result for limb 6
                ...
                // Store all 7 results
                "vmovq [{result_data_ptr} + 280], xmm0", // Store result for limb 0
                "vmovq [{result_data_ptr} + 288], xmm1", // Store result for limb 1
                "vmovq [{result_data_ptr} + 296], xmm2", // Store result for limb 2
                "vmovq [{result_data_ptr} + 304], xmm3", // Store result for limb 3
                "vmovq [{result_data_ptr} + 312], xmm4", // Store result for limb 4
                "vmovq [{result_data_ptr} + 320], xmm5", // Store result for limb 5
                "vmovq [{result_data_ptr} + 328], xmm6", // Store result for limb 6
                ...
                // Store all 7 results
                "vmovq [{result_data_ptr} + 336], xmm0", // Store result for limb 0
                "vmovq [{result_data_ptr} + 344], xmm1", // Store result for limb 1
                "vmovq [{result_data_ptr} + 352], xmm2", // Store result for limb 2
                "vmovq [{result_data_ptr} + 360], xmm3", // Store result for limb 3
                "vmovq [{result_data_ptr} + 368], xmm4", // Store result for limb 4
                "vmovq [{result_data_ptr} + 376], xmm5", // Store result for limb 5
                "vmovq [{result_data_ptr} + 384], xmm6", // Store result for limb 6
                ...
                // Store all 7 results
                "vmovq [{result_data_ptr} + 392], xmm0", // Store result for limb 0
                "vmovq [{result_data_ptr} + 400], xmm1", // Store result for limb 1
                "vmovq [{result_data_ptr} + 408], xmm2", // Store result for limb 2
                "vmovq [{result_data_ptr} + 416], xmm3", // Store result for limb 3
                "vmovq [{result_data_ptr} + 424], xmm4", // Store result for limb 4
                "vmovq [{result_data_ptr} + 432], xmm5", // Store result for limb 5
                "vmovq [{result_data_ptr} + 440], xmm6", // Store result for limb 6
                ...
                // Store all 7 results
                "vmovq [{result_data_ptr} + 448], xmm0", // Store result for limb 0
                "vmovq [{result_data_ptr} + 456], xmm1", // Store result for limb 1
                "vmovq [{result_data_ptr} + 464], xmm2", // Store result for limb 2
                "vmovq [{result_data_ptr} + 472], xmm3", // Store result for limb 3
                "vmovq [{result_data_ptr} + 480], xmm4", // Store result for limb 4
                "vmovq [{result_data_ptr} + 488], xmm5", // Store result for limb 5
                "vmovq [{result_data_ptr} + 496], xmm6", // Store result for limb 6

let wasm_bindgen = (function(exports) {
    ...
    class SteenrodCalculator {
        ...
        evaluate_adem(input) {
            ...
            try {
                ...
                const ret = wasm.steenrodcalculator_evaluate_adem(this.__wbg_ptr, ptr0, len0);
                var ptr2 = ret[0];
                var len2 = ret[1];
                if (ret[3]) {
                    ptr2 = 0; len2 = 0;
        ...
        evaluate_milnor(input) {
            ...
            try {
                const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
                const len0 = WASM_VECTOR_LEN;
                const ret = wasm.steenrodcalculator_evaluate_milnor(this.__wbg_ptr, ptr0, len0);
                var ptr2 = ret[0];
                var len2 = ret[1];
                if (ret[3]) {
                    ptr2 = 0; len2 = 0;
    ...
    exports.SteenrodCalculator = SteenrodCalculator;
    ...
    function __wbg_get_imports() {
        ...
        return {
            __proto__: null,
            "./steenrod_calculator_wasm_bg.js": import0,
        };
    }

...
impl<A : SteenrodAlgebraT + Algebra> Eq for RealProjectiveSpace<A> {}

impl<A : SteenrodAlgebraT + Algebra> Module for RealProjectiveSpace<A> {
    type Algebra = A;
...
impl<A : SteenrodAlgebraT + Algebra> ZeroModule for RealProjectiveSpace<A> {
...
impl<A : SteenrodAlgebraT + Algebra> RealProjectiveSpace<A> {
    pub fn new(
        algebra: Arc<A>,
        min: i32,
        max: Option<i32>,

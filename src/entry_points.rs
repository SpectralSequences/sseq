...
use crate::module::homomorphism::{FiniteModuleHomomorphism, ModuleHomomorphism, FreeModuleHomomorphism, IdentityHomomorphism};
use fp::matrix::Matrix;
use fp::prime::ValidPrime;
use fp::vector::{FpVector, FpVectorT};
use crate::chain_complex::{FiniteChainComplex, ChainComplex, TensorChainComplex, ChainMap};
use crate::resolution::Resolution;
use crate::resolution_homomorphism::ResolutionHomomorphism;
use crate::yoneda::{yoneda_representative_element, yoneda_representative};
...
pub fn run_define_module() -> Result<String, Box<dyn Error>> {
    crate::cli_module_loaders::interactive_module_define()
}

...
impl<M: Module> QuotientModule<M> {
    pub fn new(module : Arc<M>) -> Self {
        ...
        QuotientModule { module, subspaces : OnceBiVec::new(min_deg), basis_list : OnceBiVec::new(min_deg) }
    }
    ...
    pub fn act_on_original_basis(&self, result : &mut FpVector, coeff : u32, op_degree : i32, op_index : usize, mod_degree : i32, mod_index : usize) {
...
impl<M : Module> Module for QuotientModule<M> {
    ...
    fn compute_basis(&self, degree : i32) {
        ...
        for i in self.subspaces.len() ..= degree {
            ...
            self.subspaces.push(Subspace::new(self.prime(), dim + 1, dim));
    ...
    fn act_on_basis(&self, result : &mut FpVector, coeff : u32, op_degree : i32, op_index : usize, mod_degree : i32, mod_index : usize) {
        ...
        self.act_on_original_basis(&mut result_, coeff, op_degree, op_index, mod_degree, self.basis_list[mod_degree][mod_index]);
        self.reduce(target_deg, &mut result_);
        self.old_basis_to_new(target_deg, result, &result_);
    }

    fn basis_element_to_string(&self, degree : i32, idx : usize) -> String {
        self.module.basis_element_to_string(degree, self.basis_list[degree][idx])
    }
}
...
impl<F : ModuleHomomorphism> ModuleHomomorphism for QuotientHomomorphism<F> {
    ...
    fn apply_to_basis_element(&self, result : &mut FpVector, coeff : u32, input_degree : i32, input_idx : usize) {
        ...
        self.f.apply_to_basis_element(&mut result_, coeff, input_degree, self.s.basis_list[input_degree][input_idx]);

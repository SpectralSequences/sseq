...
import { sleep, promiseFromDomEvent } from './utils';
...
export class UIElement extends HTMLElement {
    ...
    _setupKeyBindings() {
        ...
        let [handleEnterDown, handleEnterUp] =
            this.getEventHandler('interact-submit');
        let [handleSpaceDown, handleSpaceUp] =
            this.getEventHandler('interact-toggle');
        let [handleEscapeDown, handleEscapeUp] =
            this.getEventHandler('interact-cancel');

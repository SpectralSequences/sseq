...
async function main() {
    ...
    let gi1 = app._canvas.add_glyph(
        new Vec2(0, 0),
        new Vec2(0, 0),
        shape1,
        1,
        new Vec4(0, 0, 0, 1),
        new Vec4(0.5, 0.2, 0, 1),
        new Vec4(0, 0, 0, 0),
    );
    let gi2 = app._canvas.add_glyph(
        new Vec2(1, 1),
        new Vec2(0, 0),
        shape2,
        1,
        new Vec4(0, 0, 0.4, 1),
        new Vec4(0, 0.5, 0.5, 1),
        new Vec4(1, 1, 1, 1),
    );
    let gi3 = app._canvas.add_glyph(
        new Vec2(2, 3),
        new Vec2(0, 0),
        shape4,
        1,
        new Vec4(0, 0, 0, 1),
        new Vec4(0.3, 0.7, 0.1, 1),
        new Vec4(0, 0, 0, 0),
    );
    let gi4 = app._canvas.add_glyph(
        new Vec2(2, 0),
        new Vec2(0, 0),
        shape3,
        1,
        new Vec4(0, 0, 1, 1),
        new Vec4(0, 0.8, 0.3, 1),
        new Vec4(1.0, 0.8, 1.0, 1),
    );
    let gi5 = app._canvas.add_glyph(
        new Vec2(2, 5),
        new Vec2(0, 0),
        shape5,
        1,

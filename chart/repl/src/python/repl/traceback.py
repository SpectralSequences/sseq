...
class Traceback:
    ...
    def format_exception(exception, file: str):
        return Traceback.format_traceback_list(
            Traceback.exception_to_traceback_list(exception, file)
        )
    ...
    def exception_to_traceback_list(exception, file: str) -> list[str]:
        ...
        return [
            Traceback.exception_to_traceback(e, file) for e in reversed(exception_chain)
        ]

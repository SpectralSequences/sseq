...
export interface ChartStructlineConstructorArgs extends ChartEdgeConstructorArgs {
    ...
    start_tip? : PagePropertyOrValue<ArrowTip | undefined>;
    end_tip? : PagePropertyOrValue<ArrowTip | undefined>;    
    color? : PagePropertyOrValue<Color>;
    dash_pattern? : PagePropertyOrValue<DashPattern>;
    line_width? : PagePropertyOrValue<number>; //= "default",
    bend? : PagePropertyOrValue<number>; // = 0,    
...
export class ChartStructline extends ChartEdge {
    ...
    constructor(kwargs : ChartStructlineConstructorArgs){
        ...
        this.start_tip = initialPagePropertyValue(kwargs.start_tip, undefined, "start_tip", errorContext);
        this.end_tip = initialPagePropertyValue(kwargs.end_tip, undefined, "end_tip", errorContext);

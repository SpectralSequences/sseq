...
class Resolution {
    ...
    */
    static new(f) {
        var ret = wasm.resolution_new(addHeapObject(f));
    ...
    */
    run(m) {
        ...
        wasm.resolution_run(this.ptr, ptr0, len0);
    }
}
...
class Sseq {
    ...
    */
    static new(f) {
        var ret = wasm.sseq_new(addHeapObject(f));
    ...
    */
    run(m) {
        var ptr0 = passStringToWasm0(m, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.sseq_run(this.ptr, ptr0, len0);
    }
}
__exports.Sseq = Sseq;
/**
...
class SteenrodCalculator {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_steenrodcalculator_free(ptr);
    }
    /**
    * @param {number} p
    * @returns {SteenrodCalculator}
    */
    static new(p) {
        var ret = wasm.steenrodcalculator_new(p);
        return SteenrodCalculator.__wrap(ret);
    }
    /**
    * @param {number} degree
    */
    ...
    */
    evaluate_adem(input) {
        try {
            ...
            var len0 = WASM_VECTOR_LEN;
            wasm.steenrodcalculator_evaluate_adem(retptr, this.ptr, ptr0, len0);
    ...
    * @returns {string}
    */
    evaluate_milnor(input) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            var ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len0 = WASM_VECTOR_LEN;
            wasm.steenrodcalculator_evaluate_milnor(retptr, this.ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
